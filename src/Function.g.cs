...
namespace ContentExamples
{
    public class Function
    {
        ...
        private IModelStore<ContentExamplesInputs> store;

        public async Task<ContentExamplesOutputs> Handler(ContentExamplesInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<ContentExamplesInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<ContentExamplesInputs,ContentExamplesOutputs>(store, ContentExamples.Execute);
